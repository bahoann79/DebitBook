        ...
        <div class="content mt-3">
            ...
            <form action="register" id="registerForm" method="post">
                ...
                <div class="form-group form-item mt-2">
                    ...
                    <input type="radio" class="" placeholder="" id="male" name="gender" value="male" checked hidden />

                    <button type="button" id="input-female" class="female gender"> Female </button>
                    <input type="radio" class="" placeholder="" id="female" name="gender" value="female" hidden />
                </div>
                ...
                <input type="hidden" name="otpType" value="1">
